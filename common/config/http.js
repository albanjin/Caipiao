const {createWriteStreamEnd} = require('./createWriteStreamEnd.js')
...
const requestFunc = (targetUrl,canSetHtml = true) => {
    ...
    // console.log('UserAgentList[UserAgentIndex]',UserAgentList[UserAgentIndex])
    ...
    request.on('response', (response) => {
        ...
        switch (response.headers['content-encoding']) {
            ...
            case 'gzip':
                // const a = response.pipe(zlib.createGunzip());
